...
/**
 * Solución de planificación de Timefold: la agenda completa de un escenario, con sus
 * pacientes, recursos y estaciones fijos, y el conjunto de citas que el solver debe situar en el tiempo.
 */
@PlanningSolution
public class GlaucomaSchedule {
  ...
  /**
   * Crea una agenda inicial (sin resolver) para un escenario de optimización.
   *
   * @param patientsList     pacientes del escenario
   * @param resourcesList    recursos (doctores y máquinas) del escenario
   * @param stationsList     estaciones del escenario
   * @param appointmentsList citas a situar en el tiempo por el solver
   */
